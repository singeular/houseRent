...
<script language="JavaScript" type="text/javascript">
  ...
  function checkUname(){
      $.post("/checkUname",{"userName":$("#checkName").val()},function (data) {
          if(data.result==0)
...
<DIV class=box>
<FORM action="/access" method="post" name="accessFrom">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
    <TD class=field>用 户 名：</TD>
    <TD><INPUT class=text type=text name='name' id="checkName" onblur="checkUname()"><span id="notice"></span></TD></TR>
  <TR>
