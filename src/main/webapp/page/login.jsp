...
<TABLE class=field>
  ...
  <TR>
    ...
    <TD><!-- <input type="password" class="text" name="password" /> --><INPUT 
      id=user_password class=text type=password name=password><span style="color: #ff3300">${msg}</span></TD></TR><!--
						<tr>
...
<DIV class=buttons>
  ...
  <INPUT onclick='document.location="page/regs.jsp"' value=注册 type=button>
</DIV>
